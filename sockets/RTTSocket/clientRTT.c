/************************************* clientRTT ***************************************
 * A client socket that sends a message and the time to an echo server and then
 * accepts the return packets within a multithreaded function and calculates the
 * time that it took for the packet to calculate the average round trip time.
 *
 * Note that due to limitations, this program can only be utilized within a linux
 * environment.
****************************************************************************************/
...
/***************************void *recvFunc*********************
 * A multi-threaded function that opens a thread to accept
 * communications from a previously initiated packet.
 *
 * Does not return.
 *
 ************************************************************/
